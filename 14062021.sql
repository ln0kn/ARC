...
CREATE TABLE `hosts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `designation` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `adresse` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'machine utiliser par l hote',
  `user_id` bigint(20) unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `hosts_designation_unique` (`designation`),
  UNIQUE KEY `hosts_adresse_unique` (`adresse`),
  KEY `hosts_user_id_foreign` (`user_id`),
  CONSTRAINT `hosts_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (1,'2020_12_04_093831_create_groupes_table',1),(2,'2020_12_10_190725_create_permissions_table',1),(3,'2020_12_11_093401_create_categories_table',1),(4,'2020_12_12_000000_create_users_table',1),(5,'2020_12_12_100000_create_password_resets_table',1),(6,'2020_12_12_110512_create_category_groupes_table',1),(7,'2020_12_31_093539_create_dossiers_table',1),(8,'2020_12_31_093601_create_pieces_table',1),(9,'2021_01_06_101017_create_rappels_table',1),(10,'2021_01_24_211736_create_dossier_to_deletes_table',1),(11,'2021_01_27_211250_create_rdvs_table',1),(12,'2021_04_02_224541_create_messages_table',1),(13,'2021_05_26_085423_create_hosts_table',1);
...
-- Dump completed on 2021-06-14 10:36:58
