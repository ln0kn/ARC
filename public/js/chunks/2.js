...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    logout: function logout() {
      if (localStorage.getItem('userInfo')) this.$store.dispatch('logoutUser');
    }
  }
});
  ...
  return _c(
    ...
    [
      _c("feather-icon", {
        ...
        attrs: { icon: "BellIcon", badge: this.$store.state.listeRappel.length }
      }),
      _vm._v(" "),
      _c(
        "vs-dropdown-menu",
          ...
          _c(
            ...
            [
              _c("h3", { staticClass: "text-white" }, [
                _vm._v(_vm._s(this.$store.state.listeRappel.length) + " Rappel")
              ])
            ]
          ),
          _vm._v(" "),
          _c(
            ...
            [
              _c(
                ...
                _vm._l(this.$store.state.listeRappel, function(ntf) {
                  return _c(
                    "li",
                    {
                      key: ntf.index,
                        ...
                        [
                          _c("feather-icon", {
                            attrs: {
                              ...
                              svgClasses:
                                "text-warning stroke-current mr-1 h-6 w-6"
                            }
                          }),
                          _vm._v(" "),
                          _c("div", { staticClass: "mx-2" }, [
                            _c(
                              ...
                              {
                                staticClass:
                                  "text-primary font-medium block notification-title"
                              },
                              [_vm._v(_vm._s(ntf.dossier.nom))]
                            ),
                            _vm._v(" "),
                            _c("small", [_vm._v(_vm._s(ntf.motif))])
                          ])
                        ],
                        1
                      )
          ...
          _c(
            ...
            [
              _c("p", { staticClass: "font-semibold" }, [
                _vm._v(
                  _vm._s(_vm.activeUserInfo.nom) +
                    " " +
                    _vm._s(_vm.activeUserInfo.prenom)
                )
              ])
            ]
          ),
                  ...
                  [
                    _c(
                      ...
                      [
                        ...
                        _vm._v(" "),
                        _c("span", { staticClass: "ml-2" }, [_vm._v("Message")])
                      ],
                      1
                    ),
                    _vm._v(" "),
