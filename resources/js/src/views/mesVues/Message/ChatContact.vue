...
<template>
    <div class="chat__contact flex items-center " :class="{'bg-primary-gradient text-white shadow-lg': isActiveChatUser}">
        <div class="contact__avatar mr-1">
            <vs-avatar  class="border-2 border-solid border-white" size="30px" />
        </div>
